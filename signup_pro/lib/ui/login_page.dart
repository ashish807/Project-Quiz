...
import 'package:signup_pro/helper/functions.dart';
import 'package:signup_pro/views/filght.dart';
...
class _LoginPageState extends State<LoginPage>
  ...
  signIn() async {
    if (_formKey.currentState.validate()) {
      ...
      await authService
          .signInEmailAndPass(_emailLogin, _passwordLogin)
          .then((value) {
        if (value != null) {
          setState(() {
            isLoading = false;
  ...
  signUp() async {
    if (_signupKey.currentState.validate()) {
      ...
      await authService
          .signUpWithEmailAndPassword(_emailSignup, _passwordSignup)
          .then((value) {
        if (value != null) {
          setState(() {
            isLoading = false;
  ...
  Widget _buildSignIn(BuildContext context) {
    nextpage() {
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (value) => Flight()));
    }
